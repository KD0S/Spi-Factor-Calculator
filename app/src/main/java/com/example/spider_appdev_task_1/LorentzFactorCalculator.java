...
public class LorentzFactorCalculator extends AppCompatActivity {
    double velocity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lorentz_factor_calculator);
        ...
        practiceButton.setOnClickListener(v -> switchActivities());
